            ...
            <div class="">
                ...
                <form action="./function.php" method="post">
                    ...
                    <button type="submit" name="sign_in"
                        class="px-4 py-2 bg-green-500 text-white mt-5 rounded-md w-full">Sign In</button>
                </form>
                <p class="text-[#333F51] text-center mt-3">Don't have an account? <a href="./index.php"
                        class="text-green-500">Sign up</a></p>
            </div>
        </div>
    </section>
</body>
